...
`fronts.go` proxies a peer's published service to this hub's own users,
as a link (`/~{peer}/{service}/…`) or an ingress hostname with
autocert — see [fronts.md](fronts.md).
